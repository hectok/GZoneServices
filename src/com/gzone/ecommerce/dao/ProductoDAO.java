...
public interface ProductoDAO {
    ...
    public List<Producto> findByCriteria(Connection connection, ProductoCriteria c, int startIndex, int count)
    ...
    public Producto create(Connection connection, Producto user) 
    		throws DuplicateInstanceException, DataException;

    public void update(Connection connection, Producto user) 
    		throws InstanceNotFoundException, DataException;
